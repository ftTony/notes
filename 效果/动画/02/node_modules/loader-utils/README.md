...
Tries to read the loader config from the `gulpfile.js` under the given property name (`"myLoader"` in this case) and merges the result with the loader query. For example, if your `gulpfile.js` had this property...
