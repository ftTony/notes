  ...
  <div class="container">
    <div class="top" v-if="login">
      <div class="loginhead">
        ...
        <div class="count">
          <div class="numbox">
            <div class="num">{{starnum}}</div>
            <div class="numname">被赞数</div>
          </div>
          <div class="numbox">
      ...
      <div class="open">
        <div class="flexprimary">
          ...
          <div class="tipinfo">就可以看到sei关注你啦</div>
        </div>
    ...
    <div class="list">
      <ul class="itemlist">
        <li class="item item1" @click="fabu">
          我发布的
          <span class="number" v-if="login">{{fabunum}}</span>
        </li>
        <li class="item item2">
          我卖出的
          <span class="number" v-if="login">{{sellnum}}</span>
        </li>
        <li class="item item3" @click="buy">
          我买到的
          <span class="number" v-if="login"></span>
        </li>
        <li class="item item4">
          我赞过的
          <span class="number" v-if="login">{{likenum}}</span>
        </li>
        <li class="item item5">我的拍卖</li>
        <li class="item item6">
          我的鱼贝
          <span class="number" v-if="login">{{money}}</span>
        </li>
      </ul>
    </div>
    <div class="list" v-if="login">
      <ul class="itemlist">
        ...
        <div class="item item9">闲鱼Family</div>
        <div class="item item10">帮助与反馈</div>
      </ul>
    </div>
    <div class="list">
      <ul class="itemlist">
