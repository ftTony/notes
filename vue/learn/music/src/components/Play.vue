<template>
   <div class="play">
    ...
    <div class="content">
      ...
      <img @click.stop.prevent="isShowSkinColors=false;isShowMusicList=false" :src="audio.musicImgSrc || (musicData[0]&&musicData[0].musicImgSrc)" >
...
export default {
  ...
  data () {
    return {
      playIcons: ['url("../images/play.svg")', 'url("../images/pause.svg")'],
      now: 0,
      nativeAudio: {},
      totalTime: '0:00',
...
.play {
    ...
    .content {
      ...
      .skin {
        ...
        .icon-skin-red {
          background-image: url('../images/skinRed.svg');
        }
        .icon-skin-green {
          background-image: url('../images/skinGreen.svg');
        }
        .icon-skin-blue {
          background-image: url('../images/skinBlue.svg');
        }
        .icon-skin-black {
          background-image: url('../images/skinBlack.svg');
        }
